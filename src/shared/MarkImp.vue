...
<div class="mark">
  <div class="checkbox-wrapper-3">
    <input type="checkbox" id="cbx-3" v-model="$store.state.subtest.isRequired"/>
...
export default{
  watch:{
    'this.$store.state.subtest.isRequired'(){
      this.$store.commit('setChecked',this.$store.state.subtest.isRequired);
    }
  }
}
</script>
